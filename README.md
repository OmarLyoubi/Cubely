...
Node.js 22+ est requis. Sous Windows, double-cliquez sur `OUVRIR-CUBELY.cmd`. Le lanceur démarre le serveur, attend qu'il soit prêt, puis ouvre automatiquement `http://127.0.0.1:3000`.
